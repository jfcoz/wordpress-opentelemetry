...
COPY --from=mlocati/php-extension-installer@sha256:510b061448b4dbda1aade09ed00c0ada4cccfe230586cc404b1ac876a7ce2de4 /usr/bin/install-php-extensions /usr/local/bin/
