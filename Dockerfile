...
COPY --from=mlocati/php-extension-installer@sha256:79222400f39f7ee8f4cd4b0ccdc408d4ce778e6989a144f82bd3be1b709e98bd /usr/bin/install-php-extensions /usr/local/bin/
