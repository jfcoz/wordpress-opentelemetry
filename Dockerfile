...
COPY --from=mlocati/php-extension-installer@sha256:7e349e31274ce3c8e0b946ccea073c564dc68e5f32982f5698c4f9223912beb5 /usr/bin/install-php-extensions /usr/local/bin/
