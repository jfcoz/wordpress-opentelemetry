...
COPY --from=mlocati/php-extension-installer@sha256:4fe412e00acc5dac64cad0f32ceea367df9e46f43927d7cf256cf2658b2924c1 /usr/bin/install-php-extensions /usr/local/bin/
