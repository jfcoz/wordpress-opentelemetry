...
COPY --from=mlocati/php-extension-installer@sha256:d32b64bbfae979d12591edbcf7f924d82d4964b382c910c7d56336c105ee8309 /usr/bin/install-php-extensions /usr/local/bin/
