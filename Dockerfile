...
COPY --from=mlocati/php-extension-installer@sha256:f602863c4666dbfbb02135c89f4961da08aca4e6fcec50e9ba7484676586368c /usr/bin/install-php-extensions /usr/local/bin/
