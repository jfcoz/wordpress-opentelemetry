...
COPY --from=mlocati/php-extension-installer@sha256:12a5c9124deac4f61419cb50d5f80a5a29a133af33c6ee901e9f803a8c7823d8 /usr/bin/install-php-extensions /usr/local/bin/
