...
COPY --from=mlocati/php-extension-installer@sha256:cfd7ac5ada9502f28502166d9ca4b80cca0f82ec2e739a8988b90d5ce27d7db5 /usr/bin/install-php-extensions /usr/local/bin/
