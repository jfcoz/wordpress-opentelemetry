...
COPY --from=mlocati/php-extension-installer@sha256:9dd1ac367080e4cbb30943bbd0473fc94193bfdc64783ff7d3312bde792df50a /usr/bin/install-php-extensions /usr/local/bin/
