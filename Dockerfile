...
COPY --from=mlocati/php-extension-installer@sha256:123d8ba02bc532d9e5b89237630a999dd2c5776038bb9d31f7f5aa698f613124 /usr/bin/install-php-extensions /usr/local/bin/
