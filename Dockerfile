...
COPY --from=mlocati/php-extension-installer@sha256:3bdda45f18d9b6e4810c679dc393fc68ad78880e54ab8b5d8b8b6ca69a30f764 /usr/bin/install-php-extensions /usr/local/bin/
